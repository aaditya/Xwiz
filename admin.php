...
$message =
"Hello,<br>
Thank you for registering with us. Your account has been activated...<br>
<Br>
*****LOGIN LINK*****<Br>
http://$host$path/login.php <br>
<br>
Thank You<br>
<br>
Administrator<br>
...
";
mailer($to_email,'Xwiz Registration',$message);
	}
 }
...
<div id="canvas">
<div class="can-head"><div class="left-text">Developer Administration</div><div class="right-text"><a href="<?php echo $_SESSION['uname'];?>"><?php echo $_SESSION['user_name'];?></a> . <a href="logout"><i class="fa fa-sign-out"></i></a></div></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="74%" valign="top" style="padding: 10px;">
	  ...
	  ?></p>
      <table width="80%" border="0" align="center" cellpadding="10" cellspacing="0" style="padding: 2px 5px;border: 1px solid #2eccfa;" >
        <tr>
	  ...
	  // outputting the pages
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
          ...
          <tr>
			...
			<div style="display:none;font: normal 11px arial; padding:10px;" id="edit<?php echo $rrows['id']; ?>">
...
";
if($_POST['send'] == '1') {
mailer($post['usr_email'],'Xwiz Registration',$message);
}
echo "<div class=\"msg\">User created with password $pwd....done.</div>";
      ...
      <h2><font color="#2eccfa">Create New User</font></h2>
